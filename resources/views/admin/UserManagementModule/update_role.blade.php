                ...
                <section class="es-form-area">
                    <div class="card">
                        <header class="card-header bg-gradient border-0 pt-5 pb-5 d-flex align-items-center">
                            <h2 class="text-white mb-0">Update Role - {{ $role->name }}</h2>
                        </header>
                        ...
                        <div class="card-body">
                            <form action="{{ route('update.role.submit') }}" method="POST" class="es-form es-add-form">
                                @csrf
                                                            ...
                                                            <div class="col-10 m-auto">
                                                                @foreach ($permissions as $permission)
                                                                    @if ($permission->group_name === $group->group_name)
                                                                        ...
                                                                        {{-- <script>
                                                                            let group = document.querySelector('#all_group_{{ $group->group_name }}');
                                                                            group.checked = true;
                                                                        </script> --}}
                                                                    @endif
                                                                @endforeach
