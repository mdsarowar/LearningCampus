...
{{--                                </tr>--}}
                                ...
                                @foreach($careers as $career)
                                    <tr>
                                        ...
                                        <td>{{$career->status==0? 'Inactive':'Active'}}</td>
                                        <td>
                                            <a href="{{route('view_career',$career->id)}}"><i class="fa-solid fa-eye"></i></a>&nbsp &nbsp
                                            <a href="{{route('edit_career',$career->id)}}"><i class="fa-solid fa-pencil"></i></a>&nbsp &nbsp
                                            <a href="{{route('delete_career',$career->id)}}"><i class="fa-solid fa-trash"></i></a>&nbsp &nbsp
                                        </td>
                                    </tr>
                                @endforeach
