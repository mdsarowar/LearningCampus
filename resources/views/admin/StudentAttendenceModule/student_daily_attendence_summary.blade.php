...
<p class="text-center">
    <button type="submit" id="searchAttendance" class="btn btn-primary no-print">Submit</button>
</p>    
</form>
<div class="container">
 <div class="d-flex justify-content-between mt-5 no-print">
    <a href="{{route("student.daily.attendence.download")}}" class="print_btn"><i class="fa-solid fa-download"></i>  Download</a>
