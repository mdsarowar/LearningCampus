...
{{--                                </tr>--}}
                                ...
                                @foreach($slides as $slide)
                                    <tr>
                                        ...
                                        <td>{{$slide->title}}</td>
                                        <td><img src="{{asset($slide->image)}}"  style="width: 100px;height: 100px" class="slide_pic" alt=""></td>
                                        <td>{{$slide->status==0?'Inactive':'Active'}}</td>
                                        <td>
                                            <a href="{{route('view_slide',$slide->id)}}"><i class="fa-solid fa-eye"></i></a>&nbsp &nbsp
                                            <a href="{{route('edit_slide',$slide->id)}}"><i class="fa-solid fa-pencil"></i></a>&nbsp &nbsp
                                            <a href="{{route('delete_slide',$slide->id)}}"><i class="fa-solid fa-trash"></i></a>&nbsp &nbsp
                                        </td>
                                    </tr>
                                @endforeach
