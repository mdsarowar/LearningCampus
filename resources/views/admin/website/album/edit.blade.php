            ...
            <section class="es-form-area">
                <div class="card">
                    <header class="card-header bg-gradient border-0 pt-5 pb-5 d-flex align-items-center">
                        <h2 class="text-white mb-0">Update Album</h2>
                    </header>
                    <div class="session_view_link ml-3 mt-4 mb-5">
                        <a href="{{route('add_album')}}" class="btn btn-primary"><i class="fa-solid fa-plus"></i></a>
                        <a href="{{route('view_album',$album->id)}}" class="btn btn-primary"><i class="fa-solid fa-eye"></i></a>
                    </div>
                        ...
                        <form action="{{route('update_album',$album->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10 mb-3">
                                    ...
                                    <input type="text" name="title" value="{{$album->title}}" id="">
                                </div>
