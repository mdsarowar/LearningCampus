...
<body>
        ...
        <div class="u-content">
            <div class="u-body">
                <section class="es-form-area">
                    <form action="{{ route('student.admission.submit') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card">
    ...
    {{-- <script>
        ...
        // const fileInput1 = document.getElementById("file_");
        // const fileDiv1 = document.getElementById("fileDiv1");
        // fileInput1.addEventListener("change", function() {
        //     const selectedFile_ = fileInput.files[0];
        //     console.log(selectedFile_);
        //     if (selectedFile_) {
        //         const newDiv1 = document.createElement("div");
        //         newDiv.innerHTML = "<b>File: </b>" + selectedFile_.name;
        //         fileDiv1.appendChild(newDiv)1;
        //         fileDiv1.classList.add("show");
        //     }
        // });

        // const fileInput2 = document.getElementById("file2");
        // const fileDiv2 = document.getElementById("fileDiv2");
        // fileInput2.addEventListener("change", function() {
        //     const selectedFile2 = fileInput2.files[0];
        //     console.log(selectedFile2);
        //     if (selectedFile2) {
        //         const newDiv = document.createElement("div");
        //         newDiv.innerHTML = "<b>File: </b>" + selectedFile2.name;
        //         fileDiv2.appendChild(newDiv);
        //         fileDiv2.classList.add("show");
        //     }
        // });
    </script> --}}
