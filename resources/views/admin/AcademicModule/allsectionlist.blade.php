                                ...
                                @if (!empty($sectionInfo))
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-bordered mt-3 text-center">
                                            ...
                                            <form action="{{ route('all_section_search') }}" method="POST"
                                                id="tableSearchForm">
                                                @csrf
                                                <tr>
                                                    <th scope="row"></th>
                                                ...
                                                @foreach ($sectionInfo as $section)
                                                    <tr>
                                                        ...
                                                        <td style="display: flex; align-items:center; border:0">
                                                            <a
                                                                href="{{ route('view_section') }}?section_id={{ $section['section_id'] }}"><i
                                                                    class="fa-solid fa-eye"></i></a>&nbsp
                                                            &nbsp&nbsp
                                                            <a
                                                                href="{{ route('edit_section') }}?section_id={{ $section['section_id'] }}"><i
                                                                    class="fa-solid fa-pencil"></i></a>&nbsp
                                                            &nbsp&nbsp
                                                            <a onclick="showDeleteModal('Section', {{ $section['section_id'] }})" style="background-color: transparent; color:#6b15b6"
><i class="fa-solid fa-trash"></i></a>&nbsp
                                                            &nbsp&nbsp
                                                        </td>
                                                    </tr>
                                                    @php
                                        ...
                                        <p id="no_result_msg" style="display: none">No Section Found</p>
                                        <!---- /session table ----->
                                    </div>
                                @else
                        ...
                        if (response.length === 0) {
                            ...
                            $.each(response, function(index, section) {
                                var row = '<tr>' +
                                    ...
                                    '</td>' +
                                    '<td style="display: flex; align-items:center; border:0">' +
                                    '<a href="{{ route('view_section') }}?section_id=' +
                                    section.section_id +
                                    '"><i class="fa-solid fa-eye"></i></a>&nbsp&nbsp' +
                                    '<a href="{{ route('edit_section') }}?section_id=' +
                                    section.section_id +
                                    '"><i class="fa-solid fa-pencil"></i></a>&nbsp&nbsp' +
                                    '<a onclick="showDeleteModal(\'Section\',' + section .section_id + ')" style="background-color: transparent; color:#6b15b6"><i class="fa-solid fa-trash"></i></a>&nbsp&nbsp' +
                                    '</td>' +
                                    '</tr>';
