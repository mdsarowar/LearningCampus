...
class CurrentStudentAdd extends Controller {
    /**
    ...
    public function index() {
        $tables = ['classes', 'shifts', 'sections', 'subjects', 'gender', 'religion', 'sessions', 'current_students'];
        $dataArrays = [];
    ...
    public function store( Request $request ) {
        ...
        //     $request->file('fathers_photo')->move('assets/students_photo/', $image_name);
        //     $image_url_f_photo = url('assets/students_photo/' . $image_name);
        // }
        ...
        //     $request->file('mothers_photo')->move('assets/students_photo/', $image_name);
        //     $image_url_m_photo = url('assets/students_photo/' . $image_name);
        // }
        ...
        if ( $insertData ) {
            ...
            // return $insertData;
            return redirect( route( 'current.student' ) )->with( 'error', 'Failed to create new student' );
        }
    }
    ...
    public function show( $id ) {
        $student = DB::select( "SELECT * FROM current_students where id = $id" );
        // dd($student);
        return view( 'admin.StudentModule.current_student_view', ['student' => $student[0]] );
    }
    ...
    public function edit( $id ) {
        $student = DB::select( "SELECT * FROM current_students where id = $id" );
        // dd($student);
        return view( 'admin.StudentModule.current_student_edit', ['student' => $student[0]] );
    }
    ...
    public function update( Request $request, $id ) {
        $updated = DB::table( 'current_students' )->where( 'id', $id )->update( [
            'Session'                 => $request->input( 'session' ),
            'Shift'                   => $request->input( 'shift' ),
            'Class'                   => $request->input( 'class' ),
            'Section'                 => $request->input( 'section' ),
