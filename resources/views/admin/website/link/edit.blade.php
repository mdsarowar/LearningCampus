            ...
            <section class="es-form-area">
                <div class="card">
                    ...
                    <div class="session_view_link ml-3 mt-4 mb-5">
                        <a href="{{route('add_link')}}" class="btn btn-primary"><i class="fa-solid fa-plus"></i></a>
                        <a href="{{route('view_link',$link->id)}}" class="btn btn-primary"><i class="fa-solid fa-eye"></i></a>
                    </div>
                        ...
                        <form action="{{route('update_link',$link->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10 mb-3">
                                    ...
                                    <input type="text" name="title" value="{{$link->title}}" id="">
                                </div>

                                <div class="col-md-10 mb-3">
                                    <label for="">File Upload <span>*</span></label>
                                    <input type="file" name="url" value="{{$link->url}}"id="file">
                                ...
                                <div class="col-md-10 mt-4 mb-3">
                                    <p>
                                        ...
                                        <a href="{{route('manage_link')}}" class="btn  cancel_btn border-0 text-white">Cancel</a>
                                    </p>
                                </div>
