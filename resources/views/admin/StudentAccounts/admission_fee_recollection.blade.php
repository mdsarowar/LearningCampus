                ...
                <div class="row">
                    ...
                    <div class="col-md-10 mb-3">
                        ...
                        <select name="student_name_id" id="" required>
                            ...
                            <option value="94850 - Rajon">94850 - Rajon</option>
                            <option value="45630 - Kamal">45630 - Kamal</option>
                            <option value="45633 - Khan">45633 - Khan</option>
                            <option value="45631 - Zubayer">45631 - Zubayer</option>
                            <option value="45639 - Efty">45639 - Efty</option>
                        </select>
                    </div>
                    <div class="col-md-10 mb-3">
                    ...
                    <div class="col-md-10 mt-4 mb-3">
                        ...
                        <a href="{{route("view.all.detail")}}" class="btn  cancel_btn border-0 text-white">View All</a>         
                        </p>
                    </div>
