            ...
            <section class="es-form-area">
                <div class="card">
                    <header class="card-header bg-gradient border-0 pt-5 pb-5 d-flex align-items-center">
                        <h2 class="text-white mb-0">Update Breaking News</h2>
                    </header>
                    <div class="session_view_link ml-3 mt-4 mb-5">
                        <a href="{{route('add_breaking_news')}}" class="btn btn-primary"><i class="fa-solid fa-plus"></i></a>
                        <a href="{{route('view_breaking_news',$news->id)}}" class="btn btn-primary"><i class="fa-solid fa-eye"></i></a>
                    </div>
                    <div class="session_add">
                        <form action="{{route('update_breaking_news',$news->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">

                                <div class="col-md-10 mb-3">
                                    <label for="">Title <span>*</span></label>
                                    <input type="text" name="title" value="{{$news->title}}" id="">
                                </div>
                                ...
                                <div class="col-md-10 mt-4 mb-3">
                                    <p>
                                        ...
                                        <a href="{{route('manage_breaking_news')}}" class="btn  cancel_btn border-0 text-white">Cancel</a>
                                    </p>
                                </div>
