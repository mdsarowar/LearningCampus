            ...
            <section class="es-form-area">
                <div class="card">
                    <header class="card-header bg-gradient border-0 pt-5 pb-5 d-flex align-items-center">
                        <h2 class="text-white mb-0">Update Event</h2>
                    </header>
                    <div class="session_view_link ml-3 mt-4 mb-5">
                        <a href="{{route('add_event')}}" class="btn btn-primary"><i class="fa-solid fa-plus"></i></a>
                        <a href="{{route('view_event',$event->id)}}" class="btn btn-primary"><i class="fa-solid fa-eye"></i></a>
                    </div>
                        ...
                        <form action="{{route('update_event',$event->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10 mb-3">
                                    ...
                                    <input type="text" name="name" value="{{$event->name}}" id="">
                                </div>

                                <div class="col-md-10 mb-3">
                                    <label for="">Event Date<span>*</span></label>
                                    <input type="date" name="date" value="{{$event->date}}" id=""><br>
                                </div>
                                ...
                                <div class="col-md-10 mt-4 mb-3">
                                    <p>
                                        ...
                                        <a href="{{route('manage_event')}}" class="btn  cancel_btn border-0 text-white">Cancel</a>
                                    </p>
                                </div>
