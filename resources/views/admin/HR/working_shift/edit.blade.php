            ...
            <section class="es-form-area">
                <div class="card">
                    ...
                    <div class="branch_edit">
                        <form action="{{route('update_workingshift',$shift->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">

                                <div class="col-md-10 mb-3">
                                    <label for="">Name <span>*</span></label>
                                    <input type="text" placeholder=" " value="{{$shift->name}}" name="name" id="">
                                </div>

                                <div class="col-md-10 mb-3">
                                    <label for="">Start Time <span>*</span></label>
                                    <input type="date" placeholder=" " value="{{$shift->start_time}}"  name="start_time" id="">
                                </div>

                                <div class="col-md-10 mb-3">
                                    <label for="">End Time <span>*</span></label>
                                    <input type="date" placeholder=" " value="{{$shift->end_time}}"  name="end_time" id="">
                                </div>

                                <div class="col-md-10 mb-3">
                                    <label for="">Green Limit <span>*</span></label>
                                    <input type="text" placeholder=" " value="{{$shift->green_limit}}" name="green_limit" id="">
                                </div>

                                <div class="col-md-10 mb-3">
                                    <label for="">Orange Limit<span>*</span></label>
                                    <input type="text" placeholder=" " value="{{$shift->orange_limit}}" name="orange_limit" id="">
                                </div>

                                <div class="col-md-10 mb-3">
                                    <label for="">Red Limit <span>*</span></label>
                                    <input type="text" placeholder=" "  value="{{$shift->red_limit}}" name="red_limit" id="">
                                </div>
