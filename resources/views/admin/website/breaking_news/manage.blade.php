                            ...
                            <table class="table table-bordered mt-3 text-center">
                                ...
                                @foreach($newses as $news)
                                    <tr>
                                        ...
                                        <td>{{$news->title}}</td>
                                        <td>{{$news->status==0?'Inactive':'Active'}}</td>
                                        <td>
                                            <a href="{{route('view_breaking_news',$news->id)}}"><i class="fa-solid fa-eye"></i></a>&nbsp &nbsp
                                            <a href="{{route('edit_breaking_news',$news->id)}}"><i class="fa-solid fa-pencil"></i></a>&nbsp &nbsp
                                            <a href="{{route('delete_breaking_news',$news->id)}}"><i class="fa-solid fa-trash"></i></a>&nbsp &nbsp
                                        </td>
                                    </tr>
                                @endforeach
