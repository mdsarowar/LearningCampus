...
{{--                                </tr>--}}
                                ...
                                @foreach($links as $link)
                                    <tr>
                                        ...
                                        <td>{{$link->title}}</td>
                                        <td>{{$link->url}}</td>
                                        <td>{{$link->status ==0?'Inactive':'Active'}}</td>
                                        <td>
                                            <a href="{{route('view_link',$link->id)}}"><i class="fa-solid fa-eye"></i></a>&nbsp &nbsp
                                            <a href="{{route('edit_link',$link->id)}}"><i class="fa-solid fa-pencil"></i></a>&nbsp &nbsp
                                            <a href="{{route('delete_link',$link->id)}}"><i class="fa-solid fa-trash"></i></a>&nbsp &nbsp
                                        </td>
                                    </tr>
