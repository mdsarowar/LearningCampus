...
{{--                                    </tr>--}}
                                    ...
                                    @foreach($notices as $notice)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('view_notice',$notice->id)}}"><i class="fa-solid fa-eye"></i></a>&nbsp &nbsp
                                                <a href="{{route('edit_notice',$notice->id)}}"><i class="fa-solid fa-pencil"></i></a>&nbsp &nbsp
                                                <a href="{{route('delete_notice',$notice->id)}}"><i class="fa-solid fa-trash"></i></a>&nbsp &nbsp
                                            </td>
                                        </tr>
                                    @endforeach
