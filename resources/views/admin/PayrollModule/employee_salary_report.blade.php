    ...
    <section class="es-form-area">
        <div class="card">
            <header class="card-header bg-gradient border-0 pt-5 pb-5 d-flex align-items-center">
                <h2 class="text-white mb-0">Employee Salary Report</h2>
            </header>
        </header>
        ...
        <form action="{{ route(('insert_employee_salary_report')) }}" class="es-form es-add-form" method="post" enctype="multipart/form-data">
            @csrf
            <div class="container">
