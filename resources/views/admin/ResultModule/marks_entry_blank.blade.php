                ...
                <section class="es-form-area">
                    <div class="card">
                        <header class="card-header bg-gradient border-0 pt-5 pb-5 d-flex align-items-center">
                            <h2 class="text-white mb-0">Marks Entry Blank Sheet</h2>
                        </header>
                        @if (session('error'))
                    ...
                    @endif
                        <div class="academic_info">
                            ...
                            <div class="container">
                                <form action="{{ route('marks.entry.blank.submit') }}" method="POST">
                                    @csrf
