                ...
                <section class="es-form-area">
                    <div class="card">
                        <header class="card-header bg-gradient border-0 pt-5 pb-5 d-flex align-items-center">
                            <h2 class="text-white mb-0">Add Home Work</h2>
                        </header>
                        ...
                        <ul class="breadcrumb padding-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('manage.home.work') }}">Home Work</a></li>
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Add Home Work</a></li>
                        </ul>
                        ...
                        @endif
                            <form action="{{ route('home.work.post') }}" method="POST" enctype="multipart/form-data" class="es-form es-add-form">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        ...
                                        <input type="text" name="home_work_title">
                                    </div>
                                    ...
                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        ...
                                        <label for="file" id="fileCustom"><i class="fa-solid fa-camera"></i>
                                            Choose Photo</label>
                                        <label for=""><span>Attachment file type (pdf)
                                                supported, maximum 10MB</span></label>
                                    </div> -->


                                    <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                                        <label for="day"> Home Work Details</label>
                                        <textarea class="ckeditor" id="editor1" name="home_work_detail"></textarea>
                                    </div>
