            ...
            <div class="u-body">
                <section class="es-form-area">
                    <div class="card">
                        ...
                        @endif
                        <form action="{{ route('process.student.edit.update', ['id' => $student->id]) }}"
                            method="POST">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="container">
                                    ...
                                    <div class="row mt-3 mb-4">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input type="text" name="motherPro"
                                                id=""value="{{ $student->MotherProfession }}">
                                        </div>
                                    ...
                                    <div class="row mt-3 mb-4">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <img src="{{ asset($student->FatherPhoto) }}" class="curentStuImage"
                                                alt="Father's Image">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <img src="{{ asset($student->MotherPhoto) }}" class="curentStuImage"
                                                alt="Mother's Image">
