                ...
                <form action="{{ route('insert_general_info') }}" class="es-form es-add-form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                            ...
                            <input type="text" placeholder="" name="pay_scale_title" id="pay_scale_title" required>
                        </div>
    
                        <div class="col-lg-8 offset-lg-2 col-md-12 mb-4">
                            <label for="day">Employee Type<span>*</span></label>
                            <select id="day" name="employee_type" class="es-add-select" style="display: none;" required>
