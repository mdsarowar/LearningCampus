                    ...
                    <div class="card">
                        ...
                        <div class="card-body table-responsive" id="institue">
                            <form action="" class="es-form es-add-form">
                                {{-- <a href="{{ route('students.add') }}" class="btn btn-primary no-print"><i class="fa-solid fa-plus"></i></a> --}}
                                <a href="{{ route('process.student.edit', ['id' => $student->id]) }}"
                                    class="btn btn-primary no-print"><i class="fa-solid fa-pen"></i></a>
                                {{-- <a id="printBtn" onclick="printAdmissionForm()" class="print_btn btn btn-primary no-print"><i class="fa-solid fa-print"></i></a> --}}
