...
<div class="card">
    ...
    <form action="{{route("student.wavier.store")}}" method="post">
        @csrf
    <div class="session_add">
        <div class="row">
            ...
            <div class="col-md-10 mb-3">
                ...
                <select name="waived_month" id="" required>
            ...
            <div class="col-md-10 mb-3">
                ...
                <select name="fees_type" id="" required>
                    <option value="">Select Fees Type</option>
                    <option value="Tution Fees">1.00 Tution Fees</option>
                    <option value="Registration Fees">11.00 Registration Fees</option>
                    <option value="Exam Fees">2.00 Exam Fees</option>
                    <option value="Sports Fees">3.00 Sports Fees</option>
                    <option value="Yearly Tour">30.00 Yearly Tour</option>
                    <option value="Day Care">32.00 Day Care</option>
                    <option value="Admission Fees">34.00 Admission Fees</option>
                </select>
            </div>

            <div class="col-md-10 mb-3">
                <label for="">Wavier <span>*</span></label>
                <input type="number" name="wavier" id="" placeholder="Inter your student wavier amount" required>
            </div>
            ...
            <div class="col-md-10 mb-3">
             ...
             <div class="col-md-10 mt-4 mb-3">
                <p>
                 ...
                 <a href="{{route("student.wavier.cancel")}}" class="btn  cancel_btn border-0 text-white">Cancel</a>         
                 </p>
             </div>
