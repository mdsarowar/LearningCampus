            ...
            <section class="es-form-area">
                <div class="card">
                    ...
                    <div class="session_add">
                        <form action="{{route('store_recive_boucher')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-10 mb-3">
                                    ...
                                    <p class="rad_text">
                                        <input type="radio" placeholder="Education"value="yes" name="payment_type" id="check">
                                        <b>Yes</b>
                                    </p> &nbsp; &nbsp;
                                    <p class="rad_text">
                                        <input type="radio" placeholder="Education" value="no" name="payment_type" id="check">
                                        <b>No</b>
                                    </p>
                                </div>
