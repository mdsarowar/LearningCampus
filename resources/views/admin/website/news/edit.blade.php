            ...
            <section class="es-form-area">
                <div class="card">
                    ...
                    <div class="session_view_link ml-3 mt-4 mb-5">
                        ...
                        <a href="{{route('view_news',$news->id)}}" class="btn btn-primary"><i class="fa-solid fa-eye"></i></a>
                    </div>
                        ...
                        <form action="{{route('update_news',$news->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10 mb-3">
                                    ...
                                    <img src="{{asset($news->image)}}" style="width: 100px;height: 100px" alt="">
                                    <input type="file" name="image" id="file">
                                    <label for="file" id="fileCustom" class="add_messageFile"><i class="fa-solid fa-camera"></i> Choose Photo</label><br>
                                    <span style="color: red;">Only image (png,jpg,gif) width = 260px & Height = 260px - maximum 1MB</span>
                                </div>
                                ...
                                <div class="col-md-10 mt-4 mb-3">
                                    <p>
                                        ...
                                        <a href="{{route('manage_news')}}" class="btn  cancel_btn border-0 text-white">Cancel</a>
                                    </p>
                                </div>
