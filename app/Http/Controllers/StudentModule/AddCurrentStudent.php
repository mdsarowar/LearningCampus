...
class AddCurrentStudent extends Controller {
    /**
    ...
    public function index() {
        ...
        // dd($dataArrays);
        return view( 'admin.StudentModule.current_student_add', $dataArrays );
    }
    ...
    public function destroy( Request $request ) {
        $current_id = $request->label_id;

        $query = DB::table( 'current_students' )->where( 'id', $current_id )->delete();
        if ( $query ) {
